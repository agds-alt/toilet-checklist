// ============================================
// components/ChecklistTable.tsx - UPDATED FOR FILTERS
// ============================================
'use client';
...
export default function ChecklistTable({
    ...
    const displayPeriods = selectedWeek !== null
        ? [periods[selectedWeek]]  // Show only selected week
        : periods;                  // Show all weeks

    return (
        <div className="space-y-8">
            {displayPeriods.map((period, periodIdx) => {
                // Use original index if showing single week
                const actualPeriodIdx = selectedWeek !== null ? selectedWeek : periodIdx;

                return (
                    <div key={actualPeriodIdx} className="glass-card rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow fade-in">
                        {/* Period Header */}
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-blue-200 font-medium">
                                            Monitoring Period • {period.days[0]} - {period.days[period.days.length - 1]}
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="glass-card rounded-3xl p-8 shadow-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {[
                        ...
                        { color: 'bg-red-50 border-red-300', label: '1-74', desc: 'Poor', icon: '❌' },
